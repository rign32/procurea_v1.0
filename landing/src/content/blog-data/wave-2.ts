...
Trzy minuty w VIES na dostawcę przed pierwszą płatnością. To matematyka, którą każdy powinien robić, a większość zespołów procurement mid-market nadal nie robi.`,
      statBlock: {
        columns: 4,
        stats: [
          { value: '3 min', label: 'Per supplier check', labelPl: 'Na dostawcę' },
          { value: '€47k', label: 'Lost in case study', labelPl: 'Strata w case study' },
          { value: '27', label: 'EU member states covered', labelPl: 'Państwa UE' },
          { value: '~95%', label: 'VIES accuracy', labelPl: 'Skuteczność VIES' },
        ],
      },
    },
    {
        ...
        steps: [
          {
            title: 'Open VIES',
            titlePl: 'Otwórz VIES',
            description: 'ec.europa.eu/taxation_customs/vies — free, no account, no rate limits for normal use.',
            descriptionPl: 'ec.europa.eu/taxation_customs/vies — darmowe, bez konta, bez limitów dla normalnego użycia.',
          },
          {
            title: 'Enter VAT number',
            titlePl: 'Wpisz numer VAT',
            description: 'Select the supplier country from the dropdown and paste the VAT number without the country prefix (e.g. 123456789, not DE123456789).',
            descriptionPl: 'Wybierz kraj dostawcy z listy i wklej numer VAT bez prefiksu kraju (np. 123456789, nie DE123456789).',
          },
          {
            title: 'Match identity fields',
            titlePl: 'Porównaj dane',
            description: 'VIES returns Valid / Invalid / Service Unavailable. On "Valid", compare the registered legal name and address against the invoice — name mismatch is a red flag worth one phone call.',
            descriptionPl: 'VIES zwraca Aktywny / Nieważny / Usługa niedostępna. Przy „Aktywnym" porównaj nazwę prawną i adres z fakturą — niezgodność nazwy to czerwona flaga warta jednego telefonu.',
          },
          {
            title: 'Save the evidence',
            titlePl: 'Zapisz dowód',
            description: 'Screenshot the response with the consultation number and date. Store against the supplier record in your ERP — this is audit evidence if the tax office ever asks.',
            descriptionPl: 'Zrób screenshot odpowiedzi z numerem zapytania i datą. Zapisz przy rekordzie dostawcy w ERP — to dowód audytowy, gdyby urząd kiedyś pytał.',
          },
        ],
      },
      inlineCta: {
...
Inne kraje, które spotkasz: Holandia (NL + 12 znaków kończących się B i 2 cyfry), Belgia (BE + 10 cyfr, zawsze zaczyna się od 0 lub 1), Hiszpania (ES + 9 znaków, pierwszy lub ostatni może być literą). Wszystkie jednolite w VIES — sprawdź format przed wysłaniem.`,
      warning: {
        tone: 'warning',
        title: 'VIES sync lag — expect 3-5% false "invalid" hits',
        titlePl: 'Opóźnienie synchronizacji VIES — licz się z 3-5% fałszywych „nieważnych"',
        text: 'Newly-registered suppliers can show "invalid" for 7-14 days (Poland, VAT-R form) or up to 4 weeks (Italy) before national registries sync to VIES. Before assuming fraud, ask the supplier to send the registration confirmation and retry — do not reject a valid supplier on a 2-week-old Italian number.',
        textPl: 'Nowo zarejestrowani dostawcy mogą pokazywać „nieważny" przez 7-14 dni (Polska, VAT-R) lub do 4 tygodni (Włochy), zanim rejestry krajowe zsynchronizują się z VIES. Zanim założysz oszustwo, poproś o potwierdzenie rejestracji i ponów — nie odrzucaj dobrego dostawcy na 2-tygodniowym włoskim numerze.',
      },
    },
    {
...
Trzyminutowe kontrole są nudne aż do momentu, w którym nie są.`,
      pullQuote: {
        text: 'Three-minute checks feel tedious right up until they are not. A €14.1k deposit, a €9.8k tax liability, and an unshipped order — all for skipping 180 seconds on VIES.',
        textPl: 'Trzyminutowe kontrole są nudne aż do momentu, w którym nie są. €14,1k zaliczki, €9,8k zobowiązania podatkowego, niedostarczony towar — wszystko za pominięcie 180 sekund w VIES.',
        role: 'Composite beta-cohort case',
        rolePl: 'Kompozyt z beta-cohorty',
      },
    },
    {
...
Siedem funkcji poniżej to te, które w beta cohorcie realnie zmieniają wyniki. Trzy „marketingowe" na końcu to te, które pojawiają się na pitch deckach i nie robią nic w praktyce.`,
      ...
      statBlock: {
        columns: 4,
        stats: [
          { value: '7', label: 'Features worth paying for', labelPl: 'Funkcji wartych zapłaty' },
          { value: '3', label: 'Fluff features to skip', labelPl: 'Funkcji do pominięcia' },
          { value: '10x', label: 'Funnel widening', labelPl: 'Poszerzenie lejka' },
          { value: '2-4 mo', label: 'Typical payback', labelPl: 'Typowy zwrot' },
        ],
      },
    },
    {
...
Co się liczy: czy możesz zaudytować scoring? Każda liczba w końcowym rankingu musi się wywodzić z pola źródłowego w oryginalnej ofercie. Czarna skrzynka nie nadaje się, kiedy procurement musi obronić decyzję przed finansami albo działem prawnym.`,
      comparisonTable: {
        caption: '7 features vs 3 representative vendors — feature coverage, not a full platform review.',
        captionPl: '7 funkcji vs 3 przykładowi vendorzy — pokrycie funkcji, nie pełny przegląd platformy.',
        headers: ['Feature', 'Procurea', 'Coupa', 'SAP Ariba'],
        headersPl: ['Funkcja', 'Procurea', 'Coupa', 'SAP Ariba'],
        rows: [
          ['Multilingual supplier discovery', 'Full (26 languages)', 'Partial', 'English-first'],
          ['Generative RFx with source citation', 'Full', 'Full', 'Partial'],
          ['Live-signal risk scoring', 'Full', 'Full (add-on)', 'Full (add-on)'],
          ['Spend classification (UNSPSC)', 'Partial', 'Full', 'Full'],
          ['Contract data extraction', 'Partial', 'Full', 'Full'],
          ['Multilingual outreach with tone control', 'Full', 'Partial', 'Limited'],
          ['Automated offer comparison with audit trail', 'Full', 'Full', 'Full'],
        ],
        rowsPl: [
          ['Wielojęzyczne odkrywanie dostawców', 'Pełne (26 języków)', 'Częściowe', 'Angielski-first'],
          ['Generatywne RFx z cytowaniem źródła', 'Pełne', 'Pełne', 'Częściowe'],
          ['Scoring ryzyka z sygnałami na żywo', 'Pełne', 'Pełne (dodatek)', 'Pełne (dodatek)'],
          ['Klasyfikacja wydatków (UNSPSC)', 'Częściowe', 'Pełne', 'Pełne'],
          ['Ekstrakcja danych z kontraktów', 'Częściowe', 'Pełne', 'Pełne'],
          ['Outreach wielojęzyczny z kontrolą tonu', 'Pełne', 'Częściowe', 'Ograniczone'],
          ['Automatyczne porównanie ofert z audit trail', 'Pełne', 'Pełne', 'Pełne'],
        ],
        highlighted: 0,
      },
    },
...
<strong>6. Warunki wyjścia.</strong> Jak odzyskujesz dane? Jeśli odpowiedź zawiera profesjonalną usługę płatną — odpuść. Twoje dane sourcingowe — rekordy dostawców, historia ofert, kontrakty — muszą być eksportowalne na życzenie w standardowych formatach.`,
      keyTakeaway: {
        title: 'What to prioritize in an AI procurement evaluation',
        titlePl: 'Co stawiać na pierwszym miejscu w ewaluacji AI procurement',
        items: [
          'Proof-of-value on your real data — not sandbox demos. Any vendor refusing is hiding something.',
          'Source-citation on every generative output. Hallucination guard is non-negotiable.',
          'Integration honesty — ask which fields sync, in which direction. "Production-grade SAP" without 50 references is overclaiming.',
          'Credit-based or per-campaign pricing over per-seat — mid-market payback lands in 2-4 months.',
        ],
        itemsPl: [
          'Proof-of-value na twoich realnych danych — nie demo w piaskownicy. Vendor odmawiający coś ukrywa.',
          'Cytowanie źródła na każdym generatywnym outpucie. Bezpiecznik na halucynacje jest nie-do-negocjacji.',
          'Uczciwość integracji — pytaj jakie pola, w którą stronę. „Produkcyjny SAP" bez 50 referencji to przesada.',
          'Model kredytowy lub per-kampania zamiast per-seat — zwrot mid-market typowo 2-4 miesiące.',
        ],
      },
    },
  ],
...
Żadna z kategorii nie jest nowa. Nowe w 2026 jest to, że wszystkie cztery muszą być <em>udokumentowane</em>, <em>kaskadowe</em> i <em>ciągle odświeżane</em> pod CSDDD. Raz-do-roku checkboxy nie przechodzą już audytu.`,
      ...
      comparisonTable: {
        caption: '4 risk categories × what to check × refresh cadence × escalation trigger',
        captionPl: '4 kategorie ryzyka × co sprawdzać × tempo × trigger eskalacji',
        headers: ['Category', 'What to check', 'Cadence', 'Escalation trigger'],
        headersPl: ['Kategoria', 'Co sprawdzać', 'Tempo', 'Trigger eskalacji'],
        rows: [
        ...
        rowsPl: [
          ['Finansowa', 'Biuro, sprawozdania, trend kapitału', 'Kwartalnie (strat.)', 'Spadek o 2 pasma'],
          ['Operacyjna', 'On-time delivery, wady, moce', 'Miesięcznie', '3 opóźnienia z rzędu'],
          ['Compliance', 'VIES, sankcje, certyfikaty, rejestr', 'Ciągłe / miesięczne', 'Trafienie sankcji, VIES nieważny'],
          ['ESG', 'Newsy pracownicze, kary śr., tier-2', 'Miesięcznie news + roczny audyt', 'News o prawach człowieka'],
        ],
        highlighted: 2,
      },
    },
...
Każdy punkt to 2-5 minut dla kupca z właściwymi narzędziami. Przy 50 dostawcach na kwartał to ustrukturyzowane pół dnia na kwartał, nie miesięczny projekt. Sztuka w tym, żeby narzędzia uruchamiały punkty 4, 5, 6, 7, 11, 17 automatycznie i podnosiły tylko flagi wymagające ludzkiego review.`,
      warning: {
        tone: 'warning',
        title: 'Breach notification gap — suppliers hide incidents for 60+ days',
        titlePl: 'Luka notyfikacji incydentów — dostawcy milczą 60+ dni',
        text: 'Data-protection incidents at suppliers are frequently disclosed 60-90 days after detection, well after the GDPR 72-hour window required of controllers. Your contracts must force supplier notification within 24-48 hours, with a named contact and a template incident summary. Without it, you inherit fines for their silence.',
        textPl: 'Incydenty ochrony danych u dostawców bywają ujawniane 60-90 dni po wykryciu, długo po oknie 72h z RODO wymaganym od administratora. Kontrakty muszą wymuszać notyfikację dostawcy w 24-48h, z wyznaczoną osobą kontaktową i szablonem raportu. Bez tego dziedziczysz kary za ich milczenie.',
      },
      keyTakeaway: {
        title: 'Top 5 actions from the 20-point checklist',
        titlePl: 'Top 5 działań z 20-punktowej checklisty',
        items: [
          'Run VIES + sanctions (OFAC, EU, HM Treasury) on every supplier before first payment, not just at onboarding.',
          'Track certification expiry dates and alert 90 days out — expired ISO is worse than no claim.',
          'Map concentration risk: no single-site strategic supplier without a documented backup plan.',
          'Collect the CSDDD/LkSG questionnaire for in-scope relationships, refresh annually, escalate unresolved findings.',
          'Demand tier-2 visibility for critical components — named sub-suppliers, not "we have partners".',
        ],
        itemsPl: [
          'Uruchamiaj VIES + sankcje (OFAC, UE, HM Treasury) na każdym dostawcy przed pierwszą płatnością, nie tylko przy onboardingu.',
          'Śledź daty wygaśnięcia certyfikatów i alertuj 90 dni wcześniej — wygasły ISO jest gorszy niż brak deklaracji.',
          'Zmapuj ryzyko koncentracji: brak jednozakładowego strategicznego dostawcy bez udokumentowanego backup planu.',
          'Zbierz kwestionariusz CSDDD/LkSG dla relacji w zakresie, odświeżaj rocznie, eskaluj nierozwiązane znaleziska.',
          'Wymagaj widoczności tier-2 dla krytycznych komponentów — wymienione sub-dostawcy, nie „mamy partnerów".',
        ],
      },
    },
    {
...
Błąd kupców mid-market: traktowanie Niemiec jako jednego rynku. To sieć regionalnych klastrów przemysłowych, każdy z własną specjalizacją i normami komunikacji. Trafienie we właściwy klaster to połowa sukcesu.`,
      ...
      statBlock: {
        columns: 4,
        stats: [
          { value: '45-60k', label: 'Export manufacturers', labelPl: 'Eksportujący producenci' },
          { value: '€4.1k', label: 'Avg wage / month', labelPl: 'Śr. pensja / mies.' },
          { value: '0.2-0.8%', label: 'Typical defect rate', labelPl: 'Typowy poziom wad' },
          { value: '€4.50', label: 'Handelsregister extract', labelPl: 'Wypis Handelsregister' },
        ],
      },
    },
    {
...
Praktyczny stack pierwszego przejścia: wlw.de na longlistę → regionalne IHK dla sanity check → AI-wspomagane wielojęzyczne dla pokrycia → Handelsregister dla weryfikacji przed outreach. Cztery narzędzia, 60-90 minut ustrukturyzowanej pracy, 40-80 kandydatów dla przyzwoitej kategorii.`,
      stepByStep: {
        steps: [
          {
            title: 'Longlist on wlw.de',
            titlePl: 'Longlist na wlw.de',
            description: 'Search the category (in German if you can — "Kunststoff-Spritzguss Hersteller" beats "plastic injection manufacturer"). Pull 30-50 candidates. Treat it as a starting set, not a shortlist.',
            descriptionPl: 'Szukaj kategorii (po niemiecku — „Kunststoff-Spritzguss Hersteller" bije „plastic injection manufacturer"). Wyciągnij 30-50 kandydatów. Traktuj jako punkt startu, nie shortlistę.',
          },
          {
            title: 'Sanity-check via IHK',
            titlePl: 'Sanity-check w IHK',
            description: 'Cross-reference against the regional Chamber of Commerce (IHK München, IHK Stuttgart etc.). IHK membership is compulsory, so missing firms are a yellow flag worth investigating.',
            descriptionPl: 'Porównaj z regionalną izbą handlową (IHK München, IHK Stuttgart itd.). Członkostwo jest obowiązkowe, więc brakujące firmy to żółta flaga warta sprawdzenia.',
          },
          {
            title: 'Widen via regional portals',
            titlePl: 'Poszerz przez regionalne portale',
            description: 'Industrystock.com, europages.de, firmendb.de — each surfaces different top results. Deduplicate against your longlist and add any new candidates.',
            descriptionPl: 'Industrystock.com, europages.de, firmendb.de — każdy daje inne top-wyniki. Deduplikuj względem longlisty i dodaj nowych kandydatów.',
          },
          {
            title: 'Verify in Handelsregister',
            titlePl: 'Zweryfikuj w Handelsregister',
            description: '€4.50 per extract confirms legal form, Stammkapital, Geschäftsführer tenure, and recent changes. For 10 shortlisted suppliers that is €45 of audit-defensible verification.',
            descriptionPl: '€4,50 za wypis potwierdza formę prawną, Stammkapital, staż Geschäftsführera i świeże zmiany. Dla 10 suppliers z shortlisty to €45 weryfikacji obronialnej audytowo.',
          },
          {
            title: 'Email RFQ in German',
            titlePl: 'Wyślij RFQ po niemiecku',
            description: 'Bilingual (German first, English below), from a named human address, with explicit deadline. Response rate jumps from ~20% (English-only) to ~55% in our measurements.',
            descriptionPl: 'Dwujęzyczny (niemiecki najpierw, angielski niżej), z nazwiska człowieka, z jawnym terminem. Response rate skacze z ~20% (tylko angielski) do ~55% w naszych pomiarach.',
          },
        ],
      },
      inlineCta: {
...
Dwie mniej częste formy warte rozpoznania: <em>KG</em> (Kommanditgesellschaft, komandytowa — mieszana odpowiedzialność, widywana w biznesach rodzinnych) i <em>e.K.</em> (eingetragener Kaufmann, zarejestrowany kupiec — jednoosobowy biznes z nieograniczoną odpowiedzialnością). Oba OK dla małej skali, oba wymagają dodatkowej due diligence przy większych zobowiązaniach.`,
      pullQuote: {
        text: 'Most Mittelstand firms you will quote against have been family-owned for three to five generations. Ownership continuity is not a marketing line — it is why the GF in front of you owns a 2040 delivery commitment personally.',
        textPl: 'Większość firm Mittelstandu, u których będziesz kwotował, to rodzinne biznesy trzech-pięciu pokoleń. Ciągłość właścicielska nie jest marketingowym hasłem — dlatego Geschäftsführer siedzący naprzeciwko bierze na siebie osobiście zobowiązanie dostawy w 2040.',
        role: 'On reading the Handelsregister before signing',
        rolePl: 'O czytaniu Handelsregister przed podpisem',
      },
    },
    {
...
Dwujęzyczny szablon działa dobrze: najpierw wersja niemiecka (buduje zaufanie, pokazuje szacunek dla lokalnej normy), poniżej angielska (tłumaczenie praktyczne). Wysyłaj z prawdziwego ludzkiego adresu, nie <code>noreply@</code> ani domeny masowej. Jeden z najsilniejszych sygnałów poważnego kupca to nazwisko człowieka w mailu.`,
      keyTakeaway: {
        title: 'Cold-email do\'s and don\'ts for a German factory',
        titlePl: 'Co robić i czego nie robić przy cold mailu do niemieckiej fabryki',
        items: [
          'DO send bilingual (German first, English below) — response rate ~55% vs ~20% for English-only.',
          'DO lead with exact specification (DIN/ISO standards, tolerances, volume, MOQ), then price question — not the reverse.',
          'DON\'T use noreply@, marketing trackers, or web-form auto-responders. Mittelstand reads "blast" and ignores.',
          'DON\'T skip the Handelsregister check before sending a deposit — €4.50 buys you a name-match, director tenure, and capital-paid signal.',
        ],
        itemsPl: [
          'ZRÓB dwujęzyczny (niemiecki najpierw, angielski niżej) — response rate ~55% vs ~20% dla samego angielskiego.',
          'ZRÓB start od dokładnej specyfikacji (normy DIN/ISO, tolerancje, wolumen, MOQ), potem pytanie o cenę — nie odwrotnie.',
          'NIE używaj noreply@, trackerów marketingowych, auto-responderów z formularzy webowych. Mittelstand czyta to jako „blast" i ignoruje.',
          'NIE pomijaj sprawdzenia Handelsregister przed wysłaniem zaliczki — €4,50 kupuje zgodność nazwy, staż zarządu i sygnał wpłaconego kapitału.',
        ],
      },
    },
  ],
...
Nasz szablon (<a href="/resources/library/rfq-comparison-template">do pobrania poniżej</a>) ma te trzy warstwy rozdzielone na trzy zakładki, z formułami tak podpiętymi, że aktualizujesz tylko surową zakładkę. Reszta przelicza się sama.`,
      statBlock: {
        columns: 4,
        stats: [
          { value: '10', label: 'Comparison criteria', labelPl: 'Kryteriów porównawczych' },
          { value: '200+', label: 'Procurement teams using it', labelPl: 'Zespołów procurement używa' },
          { value: '15-25%', label: 'Typical savings on award', labelPl: 'Typowe oszczędności przy wyborze' },
          { value: 'Free', label: 'No signup wall', labelPl: 'Bez bramek, bez gate' },
        ],
      },
    },
    {
...
Trzymaj się dziesięciu. Każde dodatkowe kryterium rozcieńcza sygnał i dodaje czas review. Jeśli kryterium nie zmieni decyzji — wytnij.`,
      comparisonTable: {
        caption: '10 criteria — basic Excel grid vs Procurea\'s template (row 6 = audit-defensibility core).',
        captionPl: '10 kryteriów — podstawowy Excel vs szablon Procurea (wiersz 6 = rdzeń obronności audytowej).',
        headers: ['#', 'Criterion', 'Basic Excel grid', "Procurea's template"],
        headersPl: ['#', 'Kryterium', 'Podstawowy Excel', 'Szablon Procurea'],
        rows: [
          ['1', 'Price per normalized unit', 'Manually typed', 'Auto: volume × FX × Incoterms'],
          ['2', 'MOQ & tier structure', 'Single column', 'Tier-aware formula per volume'],
          ['3', 'Lead time', 'Days only', 'Production + shipping + variance'],
          ['4', 'Payment terms', 'Text field', 'NPV at your cost of capital'],
          ['5', 'Quality certifications', 'Typed list', 'Pass/fail gate + IAF registry link'],
          ['6', 'Weighted scoring', 'None or broken', '3 presets, locked weights, audit log'],
          ['7', 'Incoterms normalization', 'Ignored', 'Freight + duty added per origin'],
          ['8', 'Financial health', 'Not captured', 'D&B / Creditsafe field + threshold'],
          ['9', 'Warranty coverage', 'Text notes', 'Defect % × annual volume cost'],
          ['10', 'Responsiveness', 'Subjective', 'Days-to-first-reply, auto-timestamped'],
        ],
        rowsPl: [
          ['1', 'Cena / znormalizowana jednostka', 'Ręcznie wpisywana', 'Auto: wolumen × FX × Incoterms'],
          ['2', 'MOQ i tiery', 'Jedna kolumna', 'Formuła tier-aware per wolumen'],
          ['3', 'Lead time', 'Tylko dni', 'Produkcja + transport + wariancja'],
          ['4', 'Warunki płatności', 'Pole tekstowe', 'NPV przy twoim koszcie kapitału'],
          ['5', 'Certyfikaty jakości', 'Lista tekstowa', 'Bramka pass/fail + link IAF'],
          ['6', 'Ważony scoring', 'Brak lub zepsuty', '3 presety, zablokowane wagi, log audytu'],
          ['7', 'Normalizacja Incoterms', 'Pomijana', 'Fracht + cło per pochodzenie'],
          ['8', 'Zdrowie finansowe', 'Nie chwytane', 'Pole D&B / Creditsafe + próg'],
          ['9', 'Pokrycie gwarancyjne', 'Notatki', 'Wada % × roczny wolumen'],
          ['10', 'Responsywność', 'Subiektywna', 'Dni-do-odpowiedzi, auto-timestamp'],
        ],
        highlighted: 5,
      },
      pullQuote: {
        text: 'When Finance asks why you picked supplier B over A, this template is your answer — dated, versioned, and tied to numbers anyone can re-check.',
        textPl: 'Kiedy Finanse pytają, dlaczego wybrałeś dostawcę B zamiast A, ten szablon jest twoją odpowiedzią — datowaną, wersjonowaną i podpiętą do liczb, które każdy może przeliczyć.',
...
Szablon poniżej jest właściwym narzędziem dla 5-15 dostawców na kampanię z zarządzalną liczbą rund. Dalej — migruj.`,
      keyTakeaway: {
        title: 'Excel vs platform — when to upgrade',
        titlePl: 'Excel vs platforma — kiedy się przesiąść',
        items: [
          'Stay on Excel if: 5-15 suppliers per campaign, 1-2 negotiation rounds, no audit mandate, one category owner.',
          'Upgrade if: 20+ suppliers, multi-round versioning, CSDDD or procurement-policy audit requirement, or multiple buyers touching the same sheet.',
          'The template stops paying back around round 3 with 15+ suppliers — re-entry time alone costs more than a mid-market tool subscription.',
          'Audit-defensibility is the tipping point: once Finance or Legal asks for decision trails, manual spreadsheets become a liability rather than a tool.',
        ],
        itemsPl: [
          'Zostań na Excelu jeśli: 5-15 dostawców na kampanię, 1-2 rundy negocjacji, brak wymogu audytu, jeden właściciel kategorii.',
          'Przejdź na narzędzie jeśli: 20+ dostawców, wersjonowanie wielorundowe, wymóg CSDDD lub polityki procurement, albo wielu kupców pracuje na tym samym arkuszu.',
          'Szablon przestaje się zwracać w okolicach rundy 3 z 15+ dostawcami — sam czas re-entry kosztuje więcej niż subskrypcja narzędzia mid-market.',
          'Obronność audytowa to punkt zwrotny: gdy finanse lub prawo pytają o ślady decyzyjne, ręczne arkusze stają się ryzykiem, nie narzędziem.',
        ],
      },
    },
  ],
...
Argument strategiczny na 2026: nie wychodzisz z Chin, bo Chiny są złe w produkcji. Chiny pozostają najefektywniejszą bazą dostawczą świata dla większości kategorii konsumenckich i przemysłowych. Dodajesz równoległe źródło, bo <em>zmienność celna, wąskie gardła celne i ryzyko geopolityczne uczyniły pojedyncze pochodzenie skądkolwiek strategiczną słabością</em> — a Chiny są najbardziej wyeksponowanym pojedynczym pochodzeniem dla większości kupców zachodnich.`,
      statBlock: {
        columns: 4,
        stats: [
          { value: '60-90d', label: 'China lead time to EU dock', labelPl: 'Lead time Chiny → UE' },
          { value: '15-30d', label: 'Europe/Turkey lead time', labelPl: 'Lead time Europa/Turcja' },
          { value: '10-25%', label: '2024-25 tariff impact (landed)', labelPl: 'Wpływ ceł 2024-25 (landed)' },
          { value: '+8%', label: 'Europe unit cost vs China', labelPl: 'Premia jednostkowa Europa vs Chiny' },
        ],
      },
    },
    {
      ...
      countryCards: [
        {
          ...
          country: 'Poland',
          countryPl: 'Polska',
          tagline: 'EU mid-volume default — plastics, metals, assembly, food',
          taglinePl: 'Domyślny +1 UE na średnim wolumenie — tworzywa, metale, montaż, żywność',
          highlights: [
            { label: 'Manufacturers', labelPl: 'Producenci', value: '45,000+', valuePl: '45 000+' },
            { label: 'Labor cost index', labelPl: 'Indeks kosztu pracy', value: '100 (Germany = 150)', valuePl: '100 (Niemcy = 150)' },
            { label: 'Lead time to Central EU', labelPl: 'Lead time do Europy Śr.', value: '1-3 days', valuePl: '1-3 dni' },
            { label: 'Duty to EU', labelPl: 'Cło do UE', value: '0% (EU member)', valuePl: '0% (członek UE)' },
          ],
        },
        {
          ...
          country: 'Turkey',
          countryPl: 'Turcja',
          tagline: 'Scale nearshore — textiles, white goods, steel, automotive wiring',
          taglinePl: 'Nearshore dla skali — tekstylia, AGD, stal, wiązki auto',
          highlights: [
            { label: 'Manufacturers', labelPl: 'Producenci', value: '80,000+', valuePl: '80 000+' },
            { label: 'Labor cost index', labelPl: 'Indeks kosztu pracy', value: '65', valuePl: '65' },
            { label: 'Lead time to EU', labelPl: 'Lead time do UE', value: '5-7 days (truck)', valuePl: '5-7 dni (tir)' },
            { label: 'Duty to EU', labelPl: 'Cło do UE', value: '0% (customs union)', valuePl: '0% (unia celna)' },
          ],
        },
        {
          ...
          tagline: 'Premium short-run — knitwear, footwear, technical textile',
          taglinePl: 'Premium krótkie serie — dzianiny, obuwie, tekstylia techniczne',
          highlights: [
            { label: 'Typical factory size', labelPl: 'Typowy rozmiar fabryki', value: '50-300 emp.', valuePl: '50-300 os.' },
            { label: 'Labor cost index', labelPl: 'Indeks kosztu pracy', value: '78', valuePl: '78' },
            { label: 'MOQ strength', labelPl: 'Siła MOQ', value: '500-5,000 units', valuePl: '500-5 000 szt.' },
            { label: 'ESG certs', labelPl: 'Certyfikaty ESG', value: 'GOTS / OEKO-TEX strong', valuePl: 'GOTS / OEKO-TEX mocne' },
          ],
        },
        {
          ...
          country: 'Romania',
          countryPl: 'Rumunia',
          tagline: 'Low-cost EU — automotive wiring, electronics assembly, basic apparel',
          taglinePl: 'Tani kraj UE — wiązki auto, montaż elektroniki, odzież basic',
          highlights: [
            { label: 'Labor cost index', labelPl: 'Indeks kosztu pracy', value: '55', valuePl: '55' },
            { label: 'Lead time to EU', labelPl: 'Lead time do UE', value: '3-5 days', valuePl: '3-5 dni' },
            { label: 'Languages', labelPl: 'Języki', value: 'EN + FR strong', valuePl: 'EN + FR mocne' },
            { label: 'IATF 16949 base', labelPl: 'Baza IATF 16949', value: '250+ auto suppliers', valuePl: '250+ dostawców auto' },
          ],
        },
      ],
...
Realistyczne moce: jeden zakwalifikowany procurement może prowadzić ten playbook dla jednej kategorii w 6 tygodni obok BAU. Dwie kategorie równolegle — wykonalne przy dyscyplinie. Trzy — pęka dla jednej osoby. Planuj odpowiednio.`,
      stepByStep: {
        steps: [
          {
            title: 'Phase 1 — Pilot (weeks 1-4)',
            titlePl: 'Faza 1 — Pilot (tygodnie 1-4)',
            description: '10-20% of category volume placed with 1-2 qualified +1 suppliers while China stays at 100% of the baseline. Objective: first-batch quality + delivery data, no production risk to existing flow.',
            descriptionPl: '10-20% wolumenu kategorii trafia do 1-2 zakwalifikowanych dostawców +1, Chiny nadal na 100% baseline. Cel: pierwsze dane jakości i dostawy, bez ryzyka dla bieżącego strumienia.',
          },
          {
            title: 'Phase 2 — Parallel (weeks 5-8)',
            titlePl: 'Faza 2 — Równolegle (tygodnie 5-8)',
            description: 'Scale the +1 to 25-35% of volume. Run both sources for the same SKUs. Compare defect rate, OTIF, and landed cost side-by-side on identical POs. This is where you learn whether the +1 holds up at volume, not just at sample size.',
            descriptionPl: 'Podnieś +1 do 25-35% wolumenu. Uruchom oba źródła na tych samych SKU. Porównaj poziom wad, OTIF i landed cost obok siebie na identycznych zamówieniach. Tu uczysz się, czy +1 wytrzymuje wolumen, a nie tylko próbkę.',
          },
          {
            title: 'Phase 3 — Ramp (weeks 9-12+)',
            titlePl: 'Faza 3 — Ramp (tygodnie 9-12+)',
            description: 'Rebalance to target split (typical steady-state: 60-70% China / 30-40% +1). Lock long-term volumes with the +1, renegotiate China at the lower share. Document the trigger that would flip the ratio (e.g. tariff +10%, lead-time spike >60 days).',
            descriptionPl: 'Przebalansuj do docelowego podziału (typowy stan ustalony: 60-70% Chiny / 30-40% +1). Zablokuj długoterminowe wolumeny z +1, renegocjuj Chiny na mniejszym udziale. Spisz trigger, który przestawi stosunek (np. cło +10%, lead time skok >60 dni).',
          },
        ],
      },
    },
...
Żadna z tych pułapek nie jest egzotycznym trybem awarii. Wszystkie trzy pojawiają się rutynowo w post-mortemach, gdy program +1, który wyglądał dobrze na papierze, nie dostarcza. Lekarstwem jest dyscyplina, nie spryt — pracuj playbook, spisz plan, uczciwie go wyceń.`,
      warning: {
        tone: 'warning',
        title: 'Common mistake — moving 100% of volume at once',
        titlePl: 'Typowy błąd — przenoszenie 100% wolumenu naraz',
        text: 'Companies that try to migrate a full category from China to a +1 in a single step routinely break their supply chain. The +1 has not been volume-tested, tooling is not fully validated, and the pricing advantage evaporates in expedited freight and rework. Stage the shift: pilot at 10-20%, parallel at 25-35%, steady-state at 30-40%. If you are not willing to keep China active at 60%+, you are doing "China-out," not China+1 — a different and much harder project.',
        textPl: 'Firmy próbujące przenieść całą kategorię z Chin do +1 jednym ruchem rutynowo łamią sobie łańcuch. +1 nie jest przetestowany w wolumenie, oprzyrządowanie nie w pełni zwalidowane, a przewaga cenowa paruje w expedited freight i reworku. Staguj przesunięcie: pilot 10-20%, równolegle 25-35%, stan ustalony 30-40%. Jeśli nie jesteś gotowy trzymać Chin aktywnych na 60%+, robisz „China-out", nie China+1 — inny i znacznie trudniejszy projekt.',
      },
    },
  ],
  faq: [
...
Lekarstwo jest strukturalne. Obroniony scorecard ma: (a) mniej kryteriów (10 to praktyczny limit), (b) zablokowane i udokumentowane wagi, (c) obiektywny scoring gdzie możliwe, zakotwiczone rubryki gdzie subiektywny, (d) wersjonowanie i audit trail. Framework poniżej spełnia wszystkie cztery reguły.`,
      statBlock: {
        columns: 4,
        stats: [
          { value: '10', label: 'Criteria (hard cap)', labelPl: 'Kryteriów (twardy limit)' },
          { value: '4', label: 'Weight templates included', labelPl: 'Szablonów wag w zestawie' },
          { value: 'Audit-defensible', label: 'Locked weights, version trail', labelPl: 'Zablokowane wagi, ślad wersji' },
          { value: '2-4×', label: 'Fairer than equal weighting', labelPl: 'Sprawiedliwszy niż równe wagi' },
        ],
      },
    },
    {
...
<strong>Customizacja.</strong> Nie customizuj lekko. Każde odejście od presetu powinno być udokumentowane zdaniem uzasadnienia („ważymy innowację na 8% zamiast 3%, bo kategoria ma aktywną transformację technologiczną"). Nieudokumentowane customy to początek awarii przerzucania wag z sekcji pierwszej.`,
      comparisonTable: {
        caption: 'Four weight templates × 10 criteria. Strategic (regulated) = recommended default for most mid-market teams.',
        captionPl: 'Cztery szablony wag × 10 kryteriów. Strategic (regulowane) = rekomendowany domyślny dla większości zespołów mid-market.',
        headers: ['Criterion', 'Commodity', 'Strategic (recommended)', 'Regulated', 'Service'],
        headersPl: ['Kryterium', 'Commodity', 'Strategic (rekomendowany)', 'Regulowane', 'Usługi'],
        rows: [
        ...
        rowsPl: [
          ['Cena (landed, znormalizowana)', '35%', '20%', '15%', '15%'],
          ['Jakość (poziom wad)', '15%', '20%', '25%', '10%'],
          ['Lead time i niezawodność', '10%', '10%', '10%', '10%'],
          ['Zdrowie finansowe', '8%', '10%', '10%', '12%'],
          ['Compliance i certyfikaty', '10%', '10%', '15%', '8%'],
          ['Zrównoważony rozwój (ESG)', '5%', '8%', '7%', '8%'],
          ['Responsywność', '5%', '7%', '5%', '20%'],
          ['Skalowalność / moce', '5%', '8%', '5%', '8%'],
          ['Zdolność innowacyjna', '2%', '3%', '3%', '5%'],
          ['Ryzyko wyjścia / zależności', '5%', '4%', '5%', '4%'],
...
<strong>Starzenie i re-scoring.</strong> Score dostawcy sprzed 18 miesięcy jest nieświeży. Strategiczni: re-score rocznie. Preferowani: co dwa lata. Transakcyjni: co trzeci zakup lub co 3 lata. Score'y, które się nie odświeżają, tworzą fałszywą pewność i przegapiają degradację dostawcy. Narzędzie powinno auto-flagować stare score'y.`,
      stepByStep: {
        steps: [
          {
            title: '1. Pick the weight template',
            titlePl: '1. Wybierz szablon wag',
            description: 'Match to the dominant failure mode in the category: Commodity, Strategic, Regulated, or Service. Lock the weights in writing before any supplier data is entered.',
            descriptionPl: 'Dopasuj do dominującego trybu awarii w kategorii: Commodity, Strategic, Regulowane, Usługi. Zablokuj wagi na piśmie zanim wprowadzisz dane dostawców.',
          },
          {
            title: '2. Score each supplier on the 10 criteria',
            titlePl: '2. Oceń każdego dostawcę na 10 kryteriach',
            description: 'Use the anchored 0-5 rubric from the framework. Objective signals come from data (RFQ, D&B, IAF registry); subjective criteria (responsiveness, innovation) must use the written rubric — no ad-hoc judgement.',
            descriptionPl: 'Użyj zakotwiczonej rubryki 0-5 z frameworku. Sygnały obiektywne z danych (RFQ, D&B, rejestr IAF); subiektywne (responsywność, innowacja) muszą iść przez spisaną rubrykę — żadnych ad-hoc ocen.',
          },
          {
            title: '3. Run the weighted calculation',
            titlePl: '3. Policz ważony wynik',
            description: 'Composite score out of 100 per supplier plus decomposition (which criteria drove the result). Apply hard-fail gates (sanctions, VAT, expired certs) before ranking — a gated supplier does not get a low score, they are removed entirely.',
            descriptionPl: 'Composite na 100 per dostawca plus rozkład (które kryteria zważyły). Zastosuj bramki hard-fail (sankcje, VAT, wygasłe certyfikaty) przed rankingiem — dostawca oblewający bramkę nie dostaje niskiego score, jest usunięty z ewaluacji.',
          },
          {
            title: '4. Document the rationale',
            titlePl: '4. Spisz uzasadnienie',
            description: 'One paragraph per finalist explaining why their score is what it is, citing the source data for each criterion. This is what makes the output audit-defensible — a reader six months later can reconstruct the decision.',
            descriptionPl: 'Jeden akapit per finalista tłumaczący, dlaczego jego score jest taki, cytując dane źródłowe per kryterium. To czyni wynik obronnym w audycie — czytający za pół roku może zrekonstruować decyzję.',
          },
          {
            title: '5. Present to the award committee',
            titlePl: '5. Zaprezentuj komitetowi decyzyjnemu',
            description: 'Ranked list, top 3 with decomposition, hard-fail log, and the locked weight template. No weight changes after this point — any mid-cycle adjustment requires re-approval and re-scoring.',
            descriptionPl: 'Lista rankingowa, top 3 z rozkładem, log hard-fail i zablokowany szablon wag. Żadnych zmian wag po tym punkcie — korekta w cyklu wymaga ponownej akceptacji i re-scoringu.',
          },
        ],
      },
    },
