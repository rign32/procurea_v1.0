  ...
  return (
    <div className="min-h-screen">
      ...
      <main id="main-content">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <RevealOnScroll>
              <div className="relative overflow-hidden rounded-3xl aspect-[21/9] sm:aspect-[21/8]">
                <img src="/industries/retail-solution.jpg" alt="" className="absolute inset-0 h-full w-full object-cover" loading="lazy" />
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 md:p-12">
                  ...
                  <div className="max-w-2xl text-xl sm:text-2xl md:text-3xl font-bold text-white leading-tight">
                    {isEN ? 'Suppliers ready. Shelves stocked. Season delivered.' : 'Dostawcy gotowi. Półki zatowarowane. Sezon dostarczony.'}
                  </div>
                </div>
              </div>
            </RevealOnScroll>
        ...
        <IndustryRelatedResources industrySlug="retail-ecommerce" tone="rose" />
