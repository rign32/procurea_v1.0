      ...
      <div className="flex min-h-screen flex-col bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-8 text-center">
          <div>
            ...
            <Link to={pathMappings.caseStudiesHub[LANG]} className="text-[hsl(var(--ds-accent))] hover:underline">
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <RevealOnScroll>
              <div className="flex flex-wrap items-center gap-2 mb-5">
                <span className="inline-flex items-center rounded-full bg-[hsl(var(--ds-accent-soft))] border border-[hsl(var(--ds-accent))]/20 px-3 py-1 text-xs font-semibold text-[hsl(var(--ds-accent))] uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-12">
                {caseStudy.stats.map((stat, i) => (
                  <div
                    key={i}
                    className="rounded-xl bg-gradient-to-br from-[hsl(var(--ds-accent-soft))] to-[hsl(var(--ds-accent-soft))]/60 border border-[hsl(var(--ds-accent))]/20 p-4 sm:p-5"
                  >
                    <div className="text-2xl sm:text-3xl font-bold font-display text-[hsl(var(--ds-accent))] leading-none mb-1.5">
                      {stat.value}
                    </div>
                    <div className="text-xs sm:text-sm text-[hsl(var(--ds-accent))]/80 leading-tight">{stat.label}</div>
                  </div>
                ))}
              </div>
            </RevealOnScroll>
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                { label: isEN ? 'The Solution' : 'Rozwiązanie', body: caseStudy.solution, color: 'accent' },
                { label: isEN ? 'The Results' : 'Wyniki', body: caseStudy.results, color: 'accent' },
              ].map((section, i) => (
          ...
          <section className="pb-16">
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
              <RevealOnScroll>
                ...
                <ol className="relative border-l-2 border-[hsl(var(--ds-accent))]/20 ml-3 space-y-6">
                  {caseStudy.visualTimeline.map((step, i) => (
                    <li key={i} className="ml-6">
                      <span className="absolute -left-[11px] flex h-5 w-5 items-center justify-center rounded-full bg-[hsl(var(--ds-accent))] ring-4 ring-white">
                        <span className="h-1.5 w-1.5 rounded-full bg-white" aria-hidden="true" />
                      </span>
                      <div className="inline-flex items-center rounded-md bg-[hsl(var(--ds-accent-soft))] border border-[hsl(var(--ds-accent))]/20 px-2.5 py-1 text-xs font-bold uppercase tracking-wider text-[hsl(var(--ds-accent))] mb-1.5">
                        {step.day}
                      </div>
              ...
              <RevealOnScroll>
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {caseStudy.keyLearnings.map((item, i) => (
                    ...
                    >
                      <CheckCircle2
                        className="mt-0.5 h-5 w-5 flex-shrink-0 text-[hsl(var(--ds-accent))]"
                        aria-hidden="true"
                      />
            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
              <RevealOnScroll>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  {/* After */}
                  <div className="rounded-2xl border border-[hsl(var(--ds-accent))]/20 bg-[hsl(var(--ds-accent-soft))]/60 p-5 sm:p-6">
                    <div className="flex items-center gap-2 mb-2">
                      <ArrowRight className="h-4 w-4 text-[hsl(var(--ds-accent))]" aria-hidden="true" />
                      <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-[hsl(var(--ds-accent))]">
                        {isEN ? 'After' : 'Po'}
                      </h3>
                    </div>
                    <p className="text-sm sm:text-base text-slate-800 leading-relaxed">
                  ...
                  {/* Saved */}
                  <div className="rounded-2xl border border-[hsl(var(--ds-accent))]/30 bg-gradient-to-br from-[hsl(var(--ds-accent-soft))] to-[hsl(var(--ds-accent-soft))]/60 p-5 sm:p-6">
                    <div className="flex items-center gap-2 mb-2">
                      <TrendingDown className="h-4 w-4 text-[hsl(var(--ds-accent))]" aria-hidden="true" />
                      <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-[hsl(var(--ds-accent))]">
                        {isEN ? 'Saved' : 'Oszczędności'}
                      </h3>
                    </div>
                    <p className="text-base sm:text-lg font-semibold text-[hsl(var(--ds-accent))] leading-relaxed">
                      {pickLang(
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              <RevealOnScroll>
                <blockquote className="relative rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 p-8 sm:p-12">
                  <Quote
                    className="absolute top-6 left-6 h-10 w-10 text-[hsl(var(--ds-accent))]/30"
                    aria-hidden="true"
                  />
                ...
                {caseStudy.featuresUsed.map(featureKey => {
                  ...
                  return (
                    <Link
                      key={featureKey}
                      to={featurePath[LANG]}
                      className="inline-flex items-center gap-2 rounded-full bg-white border border-black/[0.08] px-4 py-2 text-sm font-semibold text-slate-700 hover:border-[hsl(var(--ds-accent))]/40 hover:text-[hsl(var(--ds-accent))] transition-all"
                    >
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {otherCaseStudies.map(cs => cs && (
                  <Link
                    ...
                    className="group block rounded-2xl border border-black/[0.08] bg-white p-6 hover:shadow-[0_12px_40px_-8px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ds-accent))] focus-visible:ring-offset-2"
                  >
                    <span className="inline-block text-xs font-bold uppercase tracking-wider text-[hsl(var(--ds-accent))] mb-3">
                      {cs.industryLabel}
                    </span>
                    <h3 className="font-bold font-display text-lg mb-2 leading-tight line-clamp-2 group-hover:text-[hsl(var(--ds-accent))] transition-colors">
                      {cs.title}
                    </h3>
                    <p className="text-sm text-slate-600 line-clamp-2 mb-4">{cs.excerpt}</p>
                    <span className="inline-flex items-center gap-1 text-sm font-semibold text-[hsl(var(--ds-accent))] group-hover:translate-x-0.5 transition-transform">
                      {isEN ? 'Read' : 'Czytaj'}
