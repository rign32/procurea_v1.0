...
function IndustryPill({ icon: Icon, label }: { icon: typeof Factory; label: string }) {
  return (
    <div className="flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-white/60 bg-white/70 backdrop-blur-sm shadow-[0_1px_3px_rgba(0,0,0,0.04)] shrink-0 hover:border-brand-200 hover:bg-white/90 hover:shadow-md transition-all duration-300 group cursor-default">
