...
export function TestimonialSection() {
  ...
  return (
    <section className="relative py-[clamp(56px,8vw,112px)] overflow-hidden bg-[hsl(var(--ds-bg-2))]/50">
      <div className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-[hsl(var(--ds-accent))]/[0.06] blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-[hsl(var(--ds-accent-2))]/[0.05] blur-[100px] pointer-events-none" />

      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <RevealOnScroll parallax>
          {/* Star rating */}
          <div className="flex items-center justify-center gap-1 text-[hsl(var(--ds-cta))] mb-8">
            {[...Array(5)].map((_, i) => (
              <motion.span
                key={i}
          ...
          <div className="relative">
            ...
            <span
              aria-hidden="true"
              className="absolute -top-8 left-1/2 -translate-x-1/2 md:-top-10 lg:-top-12 text-[120px] md:text-[160px] lg:text-[200px] leading-none font-display font-bold select-none pointer-events-none text-[hsl(var(--ds-accent))]/10"
            >
              &ldquo;
            </span>
          ...
          >
            <div className="relative h-14 w-14 rounded-full bg-[hsl(var(--ds-accent-soft))] grid place-items-center">
              <span className="font-mono text-sm font-semibold text-[hsl(var(--ds-accent))]">
        ...
        >
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[hsl(var(--ds-accent))]/20 to-transparent" />
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12 md:gap-16">
            {trustIndicators.map((item, i) => (
              <div key={i} className="flex flex-col items-center gap-1.5">
                {i === 0 && (
                  <div className="flex items-center gap-0.5 text-[hsl(var(--ds-cta))] mb-0.5">
                    {[...Array(5)].map((_, j) => (
                ...
                <span className="font-mono text-2xl md:text-3xl font-semibold tracking-[-0.02em] text-[hsl(var(--ds-ink))]">
                  {item.value}
                </span>
