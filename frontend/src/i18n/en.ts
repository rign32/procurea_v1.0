...
export const EN: Translations = {
  ...
  campaigns: {
    ...
    wizard: {
      ...
      brief: {
        ...
        subtitle: 'Describe your requirement in a few sentences — AI will fill in the rest of the form for you.',
        placeholder: 'e.g. "Catering for 500 people at a conference in Berlin on December 18, vegan and gluten-free options, budget up to €40/person"',
        aiFillButton: 'Fill form with AI',
        aiFilling: 'AI is analysing the brief...',
        aiFilled: 'Form filled — you can edit in the next steps',
        aiError: 'Could not parse the brief — you can fill the form manually',
        industryLabel: 'Industry',
        industrySubtitle: 'Helps AI search for the right suppliers',
        ...
        industries: {
          ...
          manufacturingDesc: 'Raw materials, components, MRO',
          events: 'Events',
          eventsDesc: 'Catering, AV, staging',
          construction: 'Construction',
          constructionDesc: 'Subcontractors & materials',
          horeca: 'HoReCa',
          horecaDesc: 'F&B suppliers, equipment',
          healthcare: 'Healthcare',
          healthcareDesc: 'Medical devices, CE/MDR',
          retail: 'Retail / Private label',
          retailDesc: 'Manufacturers for your brand',
          logistics: 'Logistics',
          logisticsDesc: 'Racks, 3PL, parts',
          mro: 'MRO',
          mroDesc: 'Parts, service, maintenance',
          other: 'Other',
          otherDesc: 'Does not fit the above',
        },
      },
      ...
      basicInfo: {
        ...
        productNamePlaceholder: 'e.g. PE-LD pellets · catering for 500 · HVAC subcontractor',
        category: 'Category',
      ...
      logistics: {
        ...
        currency: 'Currency',
        incoterms: 'Preferred Incoterms (optional · empty = any are acceptable)',
        incotermsPlaceholder: 'EXW, FCA, DAP...',
        deliveryDate: 'Expected delivery (optional)',
        deliveryLocation: 'Delivery location (optional)',
        deliveryDateLabel: 'Expected delivery (optional)',
  ...
  feed: {
    ...
    stillSearching: 'Still searching — this campaign is exploring a wider pool than usual. Safe to close this tab; results appear once done.',
