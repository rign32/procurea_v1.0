  ...
  create: async (dto: CreateCampaignDto): Promise<{ id: string; status: string }> => {
    const backendDto = {
      ...
      searchCriteria: {
        ...
        industrySubcategory: dto.industrySubcategory,
        eventType: dto.eventType,
        constructionStage: dto.constructionStage,
        horecaVenueType: dto.horecaVenueType,
        healthcareRegClass: dto.healthcareRegClass,
        mroUrgency: dto.mroUrgency,
        logisticsSla: dto.logisticsSla,
        mfgTolerance: dto.mfgTolerance,
        retailBrandModel: dto.retailBrandModel,
